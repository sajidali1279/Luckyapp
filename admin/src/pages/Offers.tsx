    ...
    <div style={s.container}>
      ...
      {showForm && (
        <form style={s.form} onSubmit={handleCreate}>
          <h3 style={{ margin: '0 0 16px', color: '#1D3557' }}>Create Promotion</h3>
          ...
          <label style={s.label}>Bonus Cashback % (optional — adds on top of standard 5%)</label>
          <input style={s.input} type="number" min="0" max="100" value={bonusRate} onChange={(e) => setBonusRate(e.target.value)} placeholder="e.g. 5 = customers earn 10% total this promotion" />
              ...
              <div style={s.cardBody}>
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 8 }}>
                  <span style={offer.type === 'ALL_STORES' ? s.tagAll : s.tagStore}>
                    {offer.type === 'ALL_STORES' ? '🌐 All Stores' : '📍 Specific Store'}
                  </span>

...
const s: Record<string, React.CSSProperties> = {
  ...
  emptyText: { fontSize: 14, color: '#6b7280', lineHeight: 1.6, maxWidth: 480, margin: '0 auto' },
  ...
  shiftEmpty: { padding: '16px 18px', fontSize: 13, color: '#9ca3af', fontStyle: 'italic' },
  ...
  taskNum: { width: 22, height: 22, borderRadius: '50%', background: '#f3f4f6', color: '#6b7280', fontSize: 11, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 2 },
  taskBody: { flex: 1, minWidth: 0 },
  taskTitle: { fontSize: 14, fontWeight: 700, color: '#111827', marginBottom: 2 },
  taskDesc: { fontSize: 13, color: '#6b7280', lineHeight: 1.5 },

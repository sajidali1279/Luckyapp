          ...
          <div style={s.modal} onClick={(e) => e.stopPropagation()}>
            ...
            {confirmTarget.isActive && (
              <div style={{ marginBottom: 16, textAlign: 'left' }}>
                <label style={{ fontSize: 13, fontWeight: 700, color: TEXT_MUTED, textTransform: 'uppercase', letterSpacing: 0.5, display: 'block', marginBottom: 6 }}>
        ...
        <div style={s.backdrop} onClick={() => setResolveTarget(null)}>
          <div style={s.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ textAlign: 'left', marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 15, color: TEXT_MUTED, marginTop: 4, lineHeight: 1.5 }}>{resolveTarget.description}</div>
              {resolveTarget.estimatedAmt && <div style={{ fontSize: 14, color: TEXT_MUTED, marginTop: 4 }}>Estimated: ${Number(resolveTarget.estimatedAmt).toFixed(2)}</div>}
            ...
            <div style={{ textAlign: 'left', marginBottom: 12 }}>
              <label style={{ fontSize: 13, fontWeight: 700, color: TEXT_MUTED, textTransform: 'uppercase', letterSpacing: 0.5, display: 'block', marginBottom: 6 }}>Credits to Award (if approving)</label>
              <input
              ...
              />
              <label style={{ fontSize: 13, fontWeight: 700, color: TEXT_MUTED, textTransform: 'uppercase', letterSpacing: 0.5, display: 'block', marginBottom: 6 }}>Note to customer (optional)</label>
              <input
                style={{ width: '100%', padding: '10px 12px', borderRadius: 10, border: '1.5px solid #e5e7eb', fontSize: 15, boxSizing: 'border-box' as const, outline: 'none' }}
...
const s: Record<string, React.CSSProperties> = {
  ...
  modalSub: { fontSize: 15, color: TEXT_MUTED, marginBottom: 24, lineHeight: 1.5 },
  modalActions: { display: 'flex', gap: 10 },
  cancelBtn: { flex: 1, padding: '11px 0', background: '#fff', borderWidth: '1.5px', borderStyle: 'solid', borderColor: '#e5e7eb', color: TEXT_MUTED, borderRadius: 12, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
